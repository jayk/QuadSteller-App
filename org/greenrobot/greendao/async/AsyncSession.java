...
public class AsyncSession {
  ...
  private <E> AsyncOperation enqueEntityOperation(AsyncOperation.OperationType paramOperationType, Class<E> paramClass, Object paramObject, int paramInt) {
    AsyncOperation asyncOperation = new AsyncOperation(paramOperationType, this.daoSession.getDao(paramClass), null, paramObject, paramInt | this.sessionFlags);
  ...
  private AsyncOperation enqueueDatabaseOperation(AsyncOperation.OperationType paramOperationType, Object paramObject, int paramInt) {
    AsyncOperation asyncOperation = new AsyncOperation(paramOperationType, null, this.daoSession.getDatabase(), paramObject, paramInt | this.sessionFlags);
    this.executor.enqueue(asyncOperation);
    return asyncOperation;
  }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/org/greenrobot/greendao/async/AsyncSession.class
