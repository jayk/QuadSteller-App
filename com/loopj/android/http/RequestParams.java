...
public class RequestParams implements Serializable {
  ...
  public RequestParams(Object... paramVarArgs) {
    ...
    for (byte b = 0; b < i; b += 2)
      put(String.valueOf(paramVarArgs[b]), String.valueOf(paramVarArgs[b + 1])); 
  }
  
  private HttpEntity createFormEntity() {
    try {
      UrlEncodedFormEntity urlEncodedFormEntity = new UrlEncodedFormEntity();
      this(getParamsList(), this.contentEncoding);
  ...
  private List<BasicNameValuePair> getParamsList(String paramString, Object paramObject) {
    ...
    if (paramObject instanceof Map) {
      ...
      for (byte b = 0; b < i; b++) {
        linkedList.addAll(getParamsList(String.format("%s[%d]", new Object[] { paramString, Integer.valueOf(b) }), paramObject.get(b)));
      } 
    } else if (paramObject instanceof Object[]) {
      paramObject = paramObject;
      int i = paramObject.length;
      for (byte b = 0; b < i; b++) {
        linkedList.addAll(getParamsList(String.format("%s[%d]", new Object[] { paramString, Integer.valueOf(b) }), paramObject[b]));
      } 
  ...
  public void add(String paramString1, String paramString2) {
    ...
    if (paramString1 != null && paramString2 != null) {
      Object object1 = this.urlParamsWithObjects.get(paramString1);
      object = object1;
      if (object1 == null) {
        object = new HashSet();
        put(paramString1, object);
      } 
      if (object instanceof List) {
        ((List<String>)object).add(paramString2);
        return;
      } 
    } else {
      return;
    ...
    if (object instanceof Set)
      ((Set<String>)object).add(paramString2); 
  }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/com/loopj/android/http/RequestParams.class
