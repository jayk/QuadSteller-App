...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  private void moveSpinner(float paramFloat) {
    ...
    this.mProgress.setProgressRotation((-0.25F + 0.4F * f2 + 2.0F * f3) * 0.5F);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (getChildCount() != 0) {
      ...
      if (this.mTarget != null) {
        ...
        view.layout(paramInt4, paramInt3, paramInt4 + paramInt1 - getPaddingLeft() - getPaddingRight(), paramInt3 + paramInt2 - getPaddingTop() - getPaddingBottom());
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/widget/SwipeRefreshLayout.class
