  ...
  private static class ClampedScroller {
    ...
    private float getValueAt(long param1Long) {
      ...
      if (param1Long >= this.mStartTime) {
        ...
        f = this.mStopValue;
        f = AutoScrollHelper.constrain((float)(param1Long - l) / this.mEffectiveRampDown, 0.0F, 1.0F) * f + 1.0F - f1;
      } 
      return f;
    }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/widget/AutoScrollHelper.class
