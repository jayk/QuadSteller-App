  ...
  void draw(Canvas paramCanvas) {
    ...
    if (this.mRunning || this.mFinishTime > 0L) {
      ...
      if (!this.mRunning) {
        ...
        this.mClipRect.set(k - f1, 0.0F, k + f1, j);
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/widget/SwipeProgressBar.class
