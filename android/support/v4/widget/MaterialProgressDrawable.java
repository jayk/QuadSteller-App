...
class MaterialProgressDrawable extends Drawable implements Animatable {
  ...
  private int evaluateColorChange(float paramFloat, int paramInt1, int paramInt2) {
    ...
    return (int)(((paramInt2 >> 24 & 0xFF) - paramInt1) * paramFloat) + paramInt1 << 24 | (int)(((paramInt2 >> 16 & 0xFF) - j) * paramFloat) + j << 16 | (int)(((paramInt2 >> 8 & 0xFF) - k) * paramFloat) + k << 8 | (int)(((paramInt2 & 0xFF) - i) * paramFloat) + i;
  }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/widget/MaterialProgressDrawable.class
