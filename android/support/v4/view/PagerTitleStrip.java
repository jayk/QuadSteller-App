...
public class PagerTitleStrip extends ViewGroup {
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter) {
    ...
    int j = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int)((getWidth() - getPaddingLeft() - getPaddingRight()) * 0.8F)), -2147483648);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    m = this.mNextText.getBaseline();
    int i8 = Math.max(Math.max(i6, i7), m);
    i6 = i8 - i6;
    i7 = i8 - i7;
    m = i8 - m;
    ...
    i8 = Math.max(Math.max(i6 + i8, i7 + i9), m + i10);
    switch (this.mGravity & 0x70) {
      default:
        i1 = paramInt + i6;
        i4 = paramInt + i7;
        paramInt += m;
        this.mCurrText.layout(i5, i4, j, this.mCurrText.getMeasuredHeight() + i4);
        i4 = Math.min(i2, i5 - this.mScaledTextSpacing - i);
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/view/PagerTitleStrip.class
