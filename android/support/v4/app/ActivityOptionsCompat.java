      ...
      if (paramVarArgs != null) {
        ...
        while (true) {
          ...
          if (b < paramVarArgs.length) {
            arrayOfView1[b] = (View)(paramVarArgs[b]).first;
            arrayOfString1[b] = (String)(paramVarArgs[b]).second;
            b++;
            continue;
          } 
          break;
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/app/ActivityOptionsCompat.class
