  ...
  public static ActivityOptionsCompat23 makeSceneTransitionAnimation(Activity paramActivity, View[] paramArrayOfView, String[] paramArrayOfString) {
    ...
    if (paramArrayOfView != null) {
      ...
      while (true) {
        ...
        if (b < arrayOfPair1.length) {
          arrayOfPair1[b] = Pair.create(paramArrayOfView[b], paramArrayOfString[b]);
          b++;
          continue;
        } 
        break;
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v4/app/ActivityOptionsCompat23.class
