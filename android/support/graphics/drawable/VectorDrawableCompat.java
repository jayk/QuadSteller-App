...
public class VectorDrawableCompat extends VectorDrawableCommon {
  ...
  public float getPixelSize() {
    if ((this.mVectorState == null && this.mVectorState.mVPathRenderer == null) || this.mVectorState.mVPathRenderer.mBaseWidth == 0.0F || this.mVectorState.mVPathRenderer.mBaseHeight == 0.0F || this.mVectorState.mVPathRenderer.mViewportHeight == 0.0F || this.mVectorState.mVPathRenderer.mViewportWidth == 0.0F)
      return 1.0F; 
    null = this.mVectorState.mVPathRenderer.mBaseWidth;
    float f1 = this.mVectorState.mVPathRenderer.mBaseHeight;
    float f2 = this.mVectorState.mVPathRenderer.mViewportWidth;
    float f3 = this.mVectorState.mVPathRenderer.mViewportHeight;
    return Math.min(f2 / null, f3 / f1);
  }
    ...
    private Paint.Cap getStrokeLineCap(int param1Int, Paint.Cap param1Cap) {
      switch (param1Int) {
        default:
          return param1Cap;
        case 0:
          param1Cap = Paint.Cap.BUTT;
        case 1:
          param1Cap = Paint.Cap.ROUND;
        case 2:
          break;
      } 
      param1Cap = Paint.Cap.SQUARE;
    }
    ...
    private Paint.Join getStrokeLineJoin(int param1Int, Paint.Join param1Join) {
      switch (param1Int) {
        default:
          return param1Join;
        case 0:
          param1Join = Paint.Join.MITER;
        case 1:
          param1Join = Paint.Join.ROUND;
        case 2:
          break;
      } 
      param1Join = Paint.Join.BEVEL;
    }
  ...
  private static class VPath {
    ...
    public String NodesToString(PathParser.PathDataNode[] param1ArrayOfPathDataNode) {
      ...
      for (byte b = 0; b < param1ArrayOfPathDataNode.length; b++) {
        str = str + (param1ArrayOfPathDataNode[b]).type + ":";
        float[] arrayOfFloat = (param1ArrayOfPathDataNode[b]).params;
    ...
    private void drawPath(VectorDrawableCompat.VGroup param1VGroup, VectorDrawableCompat.VPath param1VPath, Canvas param1Canvas, int param1Int1, int param1Int2, ColorFilter param1ColorFilter) {
      ...
      if (f1 != 0.0F) {
        ...
        if (vFullPath.mStrokeColor != 0) {
          ...
          paint.setColorFilter(param1ColorFilter);
          paint.setStrokeWidth(vFullPath.mStrokeWidth * f3 * f1);
          param1Canvas.drawPath(this.mRenderPath, paint);
        } 
      } 
    }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/graphics/drawable/VectorDrawableCompat.class
