...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
  ...
  final int getOverlapPixelsForOffset(View paramView) {
    ...
    if (this.mOverlayTop != 0)
      i = MathUtils.constrain((int)(getOverlapRatioForOffset(paramView) * this.mOverlayTop), 0, this.mOverlayTop); 
    return i;
  }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/design/widget/HeaderScrollingViewBehavior.class
