...
public class SupportMenuInflater extends MenuInflater {
  ...
  private class MenuState {
    ...
    private <T> T newInstance(String param1String, Class<?>[] param1ArrayOfClass, Object[] param1ArrayOfObject) {
      ...
      try {
        Constructor<?> constructor1 = SupportMenuInflater.this.mContext.getClassLoader().loadClass(param1String).getConstructor(param1ArrayOfClass);
        constructor1.setAccessible(true);
        constructor1 = (Constructor<?>)constructor1.newInstance(param1ArrayOfObject);
        constructor = constructor1;
      } catch (Exception exception) {
        Log.w("SupportMenuInflater", "Cannot instantiate class: " + constructor, exception);
        constructor = null;
      } 
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/view/SupportMenuInflater.class
