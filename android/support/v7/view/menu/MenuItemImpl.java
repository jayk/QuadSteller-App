...
public final class MenuItemImpl implements SupportMenuItem {
  ...
  public boolean expandActionView() {
    boolean bool = false;
    if (hasCollapsibleActionView() && (this.mOnActionExpandListener == null || this.mOnActionExpandListener.onMenuItemActionExpand((MenuItem)this)))
  ...
  public boolean invoke() {
    ...
    if (!this.mMenu.dispatchMenuItemSelected(this.mMenu.getRootMenu(), (MenuItem)this)) {
      ...
      if (this.mActionProvider != null) {
        null = bool;
        return !this.mActionProvider.onPerformDefaultAction() ? false : null;
      } 
    } else {
      return null;
    } 
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/view/menu/MenuItemImpl.class
