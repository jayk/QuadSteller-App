...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
  ...
  public PointF computeScrollVectorForPosition(int paramInt) {
    null = getLayoutManager();
    if (null instanceof RecyclerView.SmoothScroller.ScrollVectorProvider)
      return ((RecyclerView.SmoothScroller.ScrollVectorProvider)null).computeScrollVectorForPosition(paramInt); 
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/widget/LinearSmoothScroller.class
