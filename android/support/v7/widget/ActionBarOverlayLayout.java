...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    for (paramInt1 = 0; paramInt1 < paramInt4; paramInt1++) {
      ...
      if (view.getVisibility() != 8) {
        ...
        int k = paramInt2 + layoutParams.leftMargin;
        int m = paramInt3 + layoutParams.topMargin;
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    int n = Math.max(k, this.mContent.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
    ...
    setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(i + i1 + m, getSuggestedMinimumWidth()), paramInt1, k), ViewCompat.resolveSizeAndState(n, paramInt2, k << 16));
  }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/widget/ActionBarOverlayLayout.class
