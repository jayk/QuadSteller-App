...
public class CardView extends FrameLayout {
  ...
  private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
      ...
      public void setShadowPadding(int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
        ...
        CardView.this.setPadding(CardView.this.mContentPadding.left + param1Int1, CardView.this.mContentPadding.top + param1Int2, CardView.this.mContentPadding.right + param1Int3, CardView.this.mContentPadding.bottom + param1Int4);
      }
    };
  ...
  private void initialize(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    typedArray.recycle();
    IMPL.initialize(this.mCardViewDelegate, paramContext, colorStateList, f1, f2, f4);
  }
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/widget/CardView.class
