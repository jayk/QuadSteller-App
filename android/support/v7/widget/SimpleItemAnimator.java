...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
  ...
  public boolean animateChange(@NonNull RecyclerView.ViewHolder paramViewHolder1, @NonNull RecyclerView.ViewHolder paramViewHolder2, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo1, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo2) {
    ...
    if (paramViewHolder2.shouldIgnore()) {
      int n = paramItemHolderInfo1.left;
      int i1 = paramItemHolderInfo1.top;
      return animateChange(paramViewHolder1, paramViewHolder2, i, j, n, i1);
    } 
    int k = paramItemHolderInfo2.left;
    int m = paramItemHolderInfo2.top;
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/widget/SimpleItemAnimator.class
