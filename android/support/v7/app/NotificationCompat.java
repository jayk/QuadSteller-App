...
public class NotificationCompat extends NotificationCompat {
  ...
  private static void addDecoratedBigStyleToBuilderJellybean(Notification paramNotification, NotificationCompat.Builder paramBuilder) {
    RemoteViews remoteViews = paramBuilder.getBigContentView();
    if (remoteViews == null)
      remoteViews = paramBuilder.getContentView(); 
    if (remoteViews != null) {
      RemoteViews remoteViews1 = NotificationCompatImplBase.applyStandardTemplateWithActions(paramBuilder.mContext, paramBuilder.mContentTitle, paramBuilder.mContentText, paramBuilder.mContentInfo, paramBuilder.mNumber, paramNotification.icon, paramBuilder.mLargeIcon, paramBuilder.mSubText, paramBuilder.mUseChronometer, paramBuilder.getWhenIfShowing(), paramBuilder.getPriority(), paramBuilder.getColor(), R.layout.notification_template_custom_big, false, paramBuilder.mActions);
      NotificationCompatImplBase.buildIntoRemoteViews(paramBuilder.mContext, remoteViews1, remoteViews);
      paramNotification.bigContentView = remoteViews1;
    } 
  }
  ...
  private static void addDecoratedHeadsUpToBuilderLollipop(Notification paramNotification, NotificationCompat.Builder paramBuilder) {
    ...
    RemoteViews remoteViews1 = paramBuilder.getHeadsUpContentView();
    if (remoteViews1 != null) {
      remoteViews2 = remoteViews1;
    } else {
      remoteViews2 = paramBuilder.getContentView();
    } 
    if (remoteViews1 != null) {
      remoteViews1 = NotificationCompatImplBase.applyStandardTemplateWithActions(paramBuilder.mContext, paramBuilder.mContentTitle, paramBuilder.mContentText, paramBuilder.mContentInfo, paramBuilder.mNumber, paramNotification.icon, paramBuilder.mLargeIcon, paramBuilder.mSubText, paramBuilder.mUseChronometer, paramBuilder.getWhenIfShowing(), paramBuilder.getPriority(), paramBuilder.getColor(), R.layout.notification_template_custom_big, false, paramBuilder.mActions);
      NotificationCompatImplBase.buildIntoRemoteViews(paramBuilder.mContext, remoteViews1, remoteViews2);
  ...
  private static RemoteViews addStyleGetContentViewLollipop(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor, NotificationCompat.Builder paramBuilder) {
    if (paramBuilder.mStyle instanceof MediaStyle) {
      ...
      if (bool1 || (bool2 && paramBuilder.getBigContentView() != null)) {
        bool2 = true;
      } else {
        bool2 = false;
      } 
      if (paramBuilder.mStyle instanceof DecoratedMediaCustomViewStyle && bool2) {
        RemoteViews remoteViews = NotificationCompatImplBase.overrideContentViewMedia(paramNotificationBuilderWithBuilderAccessor, paramBuilder.mContext, paramBuilder.mContentTitle, paramBuilder.mContentText, paramBuilder.mContentInfo, paramBuilder.mNumber, paramBuilder.mLargeIcon, paramBuilder.mSubText, paramBuilder.mUseChronometer, paramBuilder.getWhenIfShowing(), paramBuilder.getPriority(), paramBuilder.mActions, mediaStyle.mActionsToShowInCompact, false, null, bool1);
        if (bool1)
          NotificationCompatImplBase.buildIntoRemoteViews(paramBuilder.mContext, remoteViews, paramBuilder.getContentView()); 
    ...
    return (paramBuilder.mStyle instanceof DecoratedCustomViewStyle) ? getDecoratedContentView(paramBuilder) : addStyleGetContentViewJellybean(paramNotificationBuilderWithBuilderAccessor, paramBuilder);
  }
  ...
  public static MediaSessionCompat.Token getMediaSession(Notification paramNotification) {
    null = getExtras(paramNotification);
    if (null != null)
      if (Build.VERSION.SDK_INT >= 21) {
        Parcelable parcelable = null.getParcelable("android.mediaSession");
        if (parcelable != null)
          return MediaSessionCompat.Token.fromToken(parcelable); 
      } else {
        IBinder iBinder = BundleCompat.getBinder(null, "android.mediaSession");
        if (iBinder != null) {
  ...
  private static boolean hasMessagesWithoutSender(List<NotificationCompat.MessagingStyle.Message> paramList) {
    ...
    //   20: checkcast android/support/v4/app/NotificationCompat$MessagingStyle$Message
    //   23: invokevirtual getSender : ()Ljava/lang/CharSequence;
    //   26: ifnonnull -> 33
    //   29: iconst_1
    //   30: istore_2
    //   31: iload_2
      ...
      if (this.mStyle instanceof NotificationCompat.MessagingStyle) {
        ...
        if (charSequence != null || message != null) {
          if (charSequence == null)
            charSequence = message.getSender(); 
          return charSequence;
        } 
      } 
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/app/NotificationCompat.class
