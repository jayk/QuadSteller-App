...
class NotificationCompatImplBase {
  ...
  public static Bitmap createIconWithBackground(Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (paramInt4 == 0)
      j = 0; 
    Bitmap bitmap = createColoredBitmap(paramContext, i, j, paramInt2);
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/android/support/v7/app/NotificationCompatImplBase.class
