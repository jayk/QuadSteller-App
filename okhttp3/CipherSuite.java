...
public final class CipherSuite {
  ...
  static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() {
      public int compare(String param1String1, String param1String2) {
        byte b = -1;
        null = 4;
        int i = Math.min(param1String1.length(), param1String2.length());
        while (null < i) {
          char c1 = param1String1.charAt(null);
          char c2 = param1String2.charAt(null);
          if (c1 != c2)
            return (c1 < c2) ? b : 1; 
          null++;
        } 
...
/* Location:              /opt/home/jayk-storage/Downloads/quadstellar/classes-dex2jar.jar!/okhttp3/CipherSuite.class
